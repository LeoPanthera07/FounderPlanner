export const TextAreaField = ({ label, value, onChange, placeholder = '', rows = 3, className = '' }) => (
  <div className={`flex flex-col gap-1 ${className}`}>
    ...
    <textarea
      ...
      className="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-400 resize-none transition"
    />
  </div>
);
